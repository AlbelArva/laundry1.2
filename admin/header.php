        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                ...
                <a href="index.html" class="logo">
                    <span class="navbar-brand">Aplikasi Laundry</span>
                </a>
            ...
            <!-- End Logo Header -->
            <!-- Navbar Header -->
            <nav class="navbar navbar-header navbar-expand" data-background-color="blue">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="../assets/img/dummy.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="../assets/img/dummy.jpg" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
